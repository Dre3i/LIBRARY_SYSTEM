 ...
 * @author Andre
 */
public class Borrow_Check_Out_Pace extends javax.swing.JFrame {

    /**
     * Creates new form main1
     */
    public Borrow_Check_Out_Pace() {
        initComponents();
         image();
    }
   ...
   String ObjButtons[] = {"Yes","No"};
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String ObjButtons[] = {"Yes","No"};
        int PromptResult = JOptionPane.showOptionDialog(null,
            "You are about to borrow (1) book due on March 28, 2025.\n"
                    + "Once you proceed, you agreed to the terms and condition \n"
                    + "of the library management\n"
                    + "\n"
                    + " Would you like to continue to borrow?", "",
            JOptionPane.DEFAULT_OPTION, JOptionPane.DEFAULT_OPTION, null,
            ObjButtons,ObjButtons[1]);
        
        if(PromptResult==0)
        {
            Borrow_Success bs = new Borrow_Success();
              bs.setVisible(true);   
              dispose(); 
        }
